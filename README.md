...
Screen shot :
![Screen shot](http://applusform.github.io/skel/screenshot1.png)

#### APK 다운로드
* [Release v1.0](https://github.com/applusform/skel/releases/download/v1.0/io.github.applusform.skel.apk)
...
2. 주소 입력창에 **applusform.github.io/skel** 를 입력합니다.
